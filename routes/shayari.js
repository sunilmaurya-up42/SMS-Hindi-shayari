...
router.get("/home", shayariController.home);
router.get("/latest", shayariController.latest);
router.get("/trending", shayariController.trending);
router.get("/featured", shayariController.featured);
router.get("/random", shayariController.random);
router.get("/suggestions", shayariController.suggestions);

// Advanced routes must be before /:slug
router.get("/search", shayariController.search);
router.get("/category/:slug", shayariController.categoryWise);
router.get("/language/:language", shayariController.languageWise);
router.get("/tag/:tag", shayariController.tagWise);
router.get("/archive/:year/:month", shayariController.archive);
router.get("/most-viewed", shayariController.mostViewed);
router.get("/most-downloaded", shayariController.mostDownloaded);
router.get("/most-shared", shayariController.mostShared);
router.get("/most-copied", shayariController.mostCopied);
router.get("/slug/:slug", shayariController.validateSlug);
router.get("/redirect/:slug", shayariController.redirect);

// Version 1 API
router.get("/v1/home", shayariController.home);
router.get("/v1/latest", shayariController.latest);
router.get("/v1/trending", shayariController.trending);
router.get("/v1/featured", shayariController.featured);
router.get("/v1/random", shayariController.random);
router.get("/v1/search", shayariController.search);
router.get("/v1/:slug", shayariController.getOne);
...
router.get("/:slug", async (req, res, next) => {
    ...
    return shayariController.showPage(req, res, next);
});
